...
LINE='5 * * * * /bin/bash /docker/clawsum/scripts/run-at-chicago.sh 7 5 4 -- /usr/bin/python3 /docker/clawsum/scripts/reminders-notify.py >> /docker/clawsum/data/reports/reminders.log 2>&1'
